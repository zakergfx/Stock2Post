    ...
    if (me)
        return (<div className="ProfilPage">
            <div className="Content">
                ...
                {/* <button className="IgButton" onClick={() => window.location.replace(`https://www.instagram.com/oauth/authorize?enable_fb_login=0&force_authentication=1&client_id=3041512645997798&redirect_uri=https://${process.env.REACT_APP_SERVERNAME}/iglogin&response_type=code&scope=instagram_business_basic%2Cinstagram_business_manage_messages%2Cinstagram_business_manage_comments%2Cinstagram_business_content_publish%2Cinstagram_business_manage_insights`)} >LIER VOTRE PAGE INSTAGRAM</button> */}
