"""
Django settings for autoscoutapi project.
...
SECRET_KEY = 'django-insecure-6r05+6kms4u=277wu^crfg&g_)+g6x16=vj7)tc#eg@r+^i#7k'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework_simplejwt.authentication.JWTAuthentication',  # Activer JWT comme méthode d'authentification
    ],
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Par défaut, les vues nécessitent que l'utilisateur soit authentifié
    ],
}
...
ROOT_URLCONF = 'autoscoutapi.urls'
...
WSGI_APPLICATION = 'autoscoutapi.wsgi.application'
